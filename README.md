...
Originals are moved to quarantine for `quarantine_retention_days` (default 10) before deletion. Use `sqzarr restore <job-id>` to recover any file within that window.
