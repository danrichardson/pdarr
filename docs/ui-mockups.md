...
<div class="min-h-screen bg-stone-50 flex items-center justify-center">
  <div class="w-full max-w-sm space-y-6 p-8">
    <div class="text-center">
      <h1 class="text-2xl font-semibold text-stone-900 tracking-tight">PDARR</h1>
...
### States
- **Empty queue, idle**: "Queue is empty. PDARR will add files automatically on the next scan."
...
│          │  Quarantine path  [/media/.pdarr-quarantine  ]        │
...
│          │                                                        │
│          │  ── About ──────────────────────────────────────────  │
│          │  PDARR v1.0.0 · Go 1.22 · SQLite 3.45                │
