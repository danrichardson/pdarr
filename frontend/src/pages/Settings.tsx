      ...
      <section>
        ...
        <Card>
          <p className="text-sm text-stone-600">
            ...
            <code className="text-xs bg-stone-100 px-1 py-0.5 rounded font-mono">pdarr hash-password</code>
            {' '}and update <code className="text-xs bg-stone-100 px-1 py-0.5 rounded font-mono">pdarr.toml</code>.
          </p>
        </Card>
      </section>
