    ...
    <div className="p-6 space-y-6">
      ...
      <section>
        ...
        <Card>
          <p className="text-sm text-stone-600">
            PDARR is configured via <code className="text-xs bg-stone-100 px-1 py-0.5 rounded font-mono">pdarr.toml</code>.
          ...
          <p className="text-sm text-stone-400 mt-2">
            Default location: <code className="text-xs bg-stone-100 px-1 py-0.5 rounded font-mono">/etc/pdarr/pdarr.toml</code>
          </p>
        </Card>
      </section>
      ...
      <section>
        ...
        <Card>
          ...
          <pre className="mt-2 text-xs bg-stone-100 rounded p-3 font-mono overflow-x-auto text-stone-700">
            pdarr hash-password{'\n'}
            # Paste the output into pdarr.toml under [auth]
          </pre>
        </Card>
      </section>
      ...
      <section>
        <Card className="text-center">
          <p className="text-sm font-semibold text-stone-900">PDARR {status?.version ?? ''}</p>
          <p className="text-xs text-stone-400 mt-1">
            Self-hosted GPU media transcoder
          </p>
          <a
            href="https://github.com/danrichardson/pdarr"
            target="_blank"
            rel="noreferrer"
            className="text-xs text-amber-600 hover:underline mt-2 block"
          >
            github.com/danrichardson/pdarr
          </a>
        </Card>
      </section>
    </div>
