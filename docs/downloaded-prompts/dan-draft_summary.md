You are a skilled product writer. Produce clear, concise project summaries.
...
Based on the interview transcript above, write a 1-page plain-language project summary using ## markdown headings for each section. Include exactly these five sections in this order:
## Vision
## Core Loop
## Key Risks
## Open Questions
...
Do not add any other sections. Keep it under 600 words. No jargon. Write for a smart non-technical reader.