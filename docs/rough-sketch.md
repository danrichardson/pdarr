# PDARR — Architecture Rough Sketch
...
- **Quarantine Handler** — moves original to `.pdarr-quarantine/` in same directory (configurable location); SQLite record tracks path and expiry; background timer purges expired entries
